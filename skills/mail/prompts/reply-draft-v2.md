...
## 문체 가이드
- **인사**: 첫 줄 "안녕하세요, [이름] [직함]님." (상대 이름/직함 확인 불가 시 "안녕하세요."). 발신자 이름·소속은 입력에 명시된 경우에만 사용하고 없으면 자기소개를 생략한다.
...
- **맺음**: 상대의 다음 액션을 청하는 문장 1개 뒤에 "감사합니다."로 끝낸다. 이름·소속 서명은 발송 계정의 승인된 기본 서명에 맡긴다.
