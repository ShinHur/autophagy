...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.text:
        payload = text_pdf(
            [
                "W2-3 synthetic fixture meeting (pdf).",
                "Owner: prepare the dataset dictionary by 2026-07-24.",
                "Owner: draft the IRB amendment by 2026-07-31.",
                "Owner: send the summary mail to the lab by 2026-07-18.",
                "Person Alpha: review sensor firmware by 2026-07-22.",
