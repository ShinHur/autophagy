...
- production: the owner's DM reply ``저장 <draft-id>`` is independently verified
...
USER_AGENT = "DiscordBot (https://github.com, 0)"
DM_SCAN_LIMIT = 50
APPROVE_EMOJI = "\u2705"
CANCEL_EMOJI = "\u26d4"
...
def create_draft(action: str, slug: str, note_text: str, channel_id: str) -> dict:
