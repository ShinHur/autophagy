...
peers:
  agent-owner:
    bot_user_id: "1000000000000001"
    bot_name: Sandbox Agent
  peer-sandbox:
    bot_user_id: "1000000000000002"
    bot_name: Sandbox Peer
YAML
...
import automation.interop.injection_adapter' 2>/dev/null; then
  ...
  # Canonical synthetic IDs keep this sandbox independent of any deployment.
  test_owner="100000000000000004"
  ...
  cli sign --draft "$draft_id" --out "$work/wrong-owner.json" --user-id "100000000000000005" >/dev/null
