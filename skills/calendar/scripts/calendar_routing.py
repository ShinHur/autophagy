...
DEFAULT_REPO_ROOT: Final = Path(__file__).resolve().parents[3]
DEFAULT_PEERS_CONFIG: Final = DEFAULT_REPO_ROOT / "configs" / "peers.yaml"
DEFAULT_OWNER_AGENT_ID: Final = "agent-owner"
