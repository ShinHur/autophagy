...
def test_site_when_selected_then_uses_the_hash_bound_bridge(
    ...
    assert action.argv[action.argv.index("--expected-config-sha256") + 1].startswith(
        "sha256:"
    )
