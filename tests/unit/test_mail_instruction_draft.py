...
def test_cmd_draft_creates_instruction_draft_no_post(
    ...
    assert record["argv"][1].endswith("site_mail_backend.py")
    assert record["argv"][2] == "send"
    assert record["site_backend_config_sha256"] == BACKEND_HASH
