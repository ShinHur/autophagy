...
APPROVAL_PRODUCERS: Final[Mapping[str, str]] = {
    "automation/drive_archive/sync_cli.py::cmd_request": "automation/drive_archive/approval_adapter.py",
...
_LIFECYCLE_HOSTS: Final[Mapping[str, str]] = {
    "automation/drive_archive/approval_adapter.py": "automation/drive_archive/sync_cli.py",
...
_ADAPTER_POSTERS: Final[frozenset[str]] = frozenset({
    "automation/drive_archive/approval_adapter.py::DriveApprovalGate.post",
...
_POSTING_PRIMITIVE_IMPLEMENTATIONS: Final[frozenset[str]] = frozenset({
    "automation/drive_archive/discord.py::DiscordApprovals.post",
...
APPROVAL_KINDS: Final[Mapping[str, str]] = {
    "automation/drive_archive/sync_cli.py::cmd_request": "drive-archive",
...
_RECORD_WRITERS: Final[Mapping[str, str]] = {
    "automation/drive_archive/approval_adapter.py::DriveApprovalGate.commit": "automation/drive_archive/pending.py",
