...
from approval_characterization_fixtures import _BINDING_FIELDS
...
@pytest.mark.parametrize(
    ...
    (
        ...
        (
            "automation/drive_archive/pending.py",
            "PendingBatch",
            "to_json",
            ("action_hash", "target_id", "message_id", "project", "created_at", "files",
             "kind", "surface", "channel_id", "policy_version"),
            ("path", "sha256"),
        ),
    ),
    ids=("patent-manifest", "repair-pending", "drive-archive-pending"),
)
...
@pytest.mark.parametrize(
    ...
    (
        (
            "DeploySpec",
            ("skill", "digest", "deploy_nonce", "review_status", "provenance", "binding"),
