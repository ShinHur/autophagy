...
def _build_vault(root: Path) -> None:
    ...
    _write(root, "001_SYNTHETIC_PARA/y.md", "# 노트 y\n내용")
...
def test_scan_obsidian_present_keys_exactly_reflect_non_excluded_files(
    ...
    assert present == {
        ...
        "obsidian:001_SYNTHETIC_PARA/y.md",
        "obsidian:inbox.md",
    }
...
def test_scan_obsidian_source_key_and_folder_metadata(tmp_path: Path) -> None:
    ...
    note_y = by_key["obsidian:001_SYNTHETIC_PARA/y.md"]
    assert note_y.chunks[0].metadata["folder"] == "001_SYNTHETIC_PARA"
