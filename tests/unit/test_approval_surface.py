...
from tests.unit._synthetic import APPROVALS_CHANNEL_ID, OWNER_DM_CHANNEL_ID, OWNER_ID
...
SKILL_CHANNEL_ID = APPROVALS_CHANNEL_ID

type TransitionLedger = Mapping[
    ApprovalKind,
