...
from automation import skill_gate, skill_gate_specs, skill_gate_surface
...
_APPROVALS_CHANNEL_ID = "100000000000000004"
_AGENT_BOT_ID = "100000000000000005"
_PEER_BOT_ID = "100000000000000006"
_REQUEST_TIMESTAMP = "2026-07-17T00:00:00.000000+00:00"
_ATTESTATION_TIMESTAMP = "2026-07-17T00:01:00.000000+00:00"
_REQUEST_CONTENT = skill_gate_specs.DeploySpec(
    skill="calendar",
    digest=_DIGEST,
    deploy_nonce=_NONCE,
    review_status="- review: ✅ PASS (frontmatter/scenario/secret_scan/content_digest 4/4, sha256-bound)",
