...
OWNER_DM_CHANNEL = OWNER_DM_CHANNEL_ID
APPROVE = "\u2705"
CANCEL = "\u26d4"
...
def env(tmp_path, monkeypatch):
    ...
    key_file.write_text("ssh-ed25519 AAAAtest test\n", encoding="utf-8")
    ...
    perms.write_text(json.dumps({"permissions": [{"id": "1", "type": "user", "role": "owner", "emailAddress": "owner@example.invalid"}]}), encoding="utf-8")
    _stub(
    ...
    monkeypatch.setenv("PATENT_SSH_PUBKEY", str(key_file))
