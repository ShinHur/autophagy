#!/usr/bin/env python3
"""W3-6 bank actuator for the w3-calendar scenario — runs on a test account.
...
def main() -> int:
    ...
    parser.add_argument("--approvals-log", required=True, type=Path)
    args = parser.parse_args()
    global REAL_APPROVALS
    REAL_APPROVALS = args.approvals_log
