"""Offline S2 legacy-drain fixture probe; never targets live state."""
...
from tests.unit._synthetic import fake_snowflake  # noqa: E402 - direct execution adds the repo root above.

JsonValue: TypeAlias = str | int | float | bool | None | list["JsonValue"] | dict[str, "JsonValue"]
Call: TypeAlias = tuple[str, str]

_GUILD = fake_snowflake(7)
_OWNER_DM = fake_snowflake(8)
_OWNER = fake_snowflake(9)
