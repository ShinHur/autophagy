...
Runs on the observer test account. Observes the W3-4 hub end-to-end for one synthetic
...
DB = Path(os.environ["E2E_REPORT_HUB_DB"])
CREDENTIALS = Path(os.environ["E2E_REPORT_HUB_CREDENTIALS"])
DASHBOARD = os.environ["E2E_REPORT_HUB_DASHBOARD_URL"]
