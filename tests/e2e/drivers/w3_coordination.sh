...
for key in E2E_REMOTE_HOST E2E_PRIMARY_ACCOUNT E2E_PEER_ACCOUNT E2E_APPROVAL_LOG E2E_DISCORD_GUILD_NAME; do
  [[ -n "${!key:-}" ]] || { echo "SKIP w3-coordination: missing $key (requires SSH/sudo, both gateways, Discord, calendar, and coordination services)"; exit 77; }
done
...
observations = {
    ...
    "overall": {
        ...
        "gateway_agent_active": "gateway primary=active" in log,
