#!/usr/bin/env bash
# W3-3 per-scenario E2E runner — executes on the primary test account.
...
APPR="${E2E_APPROVAL_LOG:?E2E_APPROVAL_LOG is required}"
...
common=(request --peer agent-peer --summary "$SUMMARY"
