...
proposes each durable-judgment entry to the decision twin for the owner-DM
✅ (idempotent, one live confirm per entry), removes the source only after the
persisted twin binding verifies, and DMs the owner on actionable changes.  Empty
...
if __name__ == "__main__":
    ...
    if result.promoted or result.deleted or result.alerted:
