...
def _dashboard_host() -> str:
    """Resolve the host both rotation probes target, defaulting to loopback."""
    return config_env.optional_env("CREDENTIAL_ROTATION_DASHBOARD_HOST") or "127.0.0.1"
...
ROTATION_TARGETS: Final[Mapping[str, RotationTarget]] = MappingProxyType(
    {
        "kanban": RotationTarget(
            ...
            note_path=Path("/home/agent/.hermes/dashboard-credentials.txt"),
        ...
        "report-hub": RotationTarget(
            ...
            note_path=Path("/home/ops/report-hub/dashboard-credentials.txt"),
