"""Aggregation and alert evaluation over PII-free entity-preflight quality records.

Pure functions only: this module reads records, computes rates and latency, and
reports which alert conditions hold. It opens no surface, starts no watcher and
exports nothing — dispatching is the caller's business.
...
from .gate_quality import GateQualityRecord, QualityDecision
