...
Soft cap: when month-to-date spend exceeds $15 (COST_REPORT_SOFT_CAP
override for tests), the report includes an alert line.
...
Test hooks (never set on the production cron path):
  ...
  COST_REPORT_SOFT_CAP       alert threshold in USD (default 15)
"""
...
def main() -> int:
    soft_cap = float(os.environ.get("COST_REPORT_SOFT_CAP", SOFT_CAP_DEFAULT))
